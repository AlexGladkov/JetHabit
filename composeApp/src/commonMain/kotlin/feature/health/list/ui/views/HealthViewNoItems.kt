package feature.health.list.ui.views
...
import tech.mobiledeveloper.jethabit.resources.health_no_items
import ui.themes.JetHabitTheme
import ui.themes.components.JetHabitButton

@Composable
internal fun HealthViewNoItems(
    onTrackClick: () -> Unit
) {
    Surface(
        ...
        Box(modifier = Modifier.fillMaxSize()) {
            Column(
                ...
                Text(
                    ...
                    text = stringResource(Res.string.health_no_items),
